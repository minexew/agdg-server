...
namespace agdg {
	...
	public:
		virtual void on_chat(int eid, const std::string& text, bool html) = 0;
		...
		virtual void on_entity_update(int eid, const glm::vec3& pos, const glm::vec3& dir, int half_latency) = 0;
	};
	...
	public:
		...
		virtual void broadcast_chat(int eid, const std::string& text, bool html) = 0;
		virtual void broadcast_entity_update(int eid, const glm::vec3& pos, const glm::vec3& dir, int half_latency) = 0;
